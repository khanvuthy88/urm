odoo.define('pos_retail.multi_unit_of_measure', function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        is_multi_unit_of_measure: function () {
            var uom_items = this.pos.uoms_prices_by_product_tmpl_id[this.product.product_tmpl_id[0]]
            if (!uom_items) {
                return false;
            }
        ...
        button_click: function () {
            ...
            if (order) {
                ...
                if (selected_orderline) {
                    ...
                    var uom_items = this.pos.uoms_prices_by_product_tmpl_id[product.product_tmpl_id[0]]
                    if (!uom_items) {
